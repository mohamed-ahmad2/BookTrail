...
class _AnimatedPulseRectangleState extends State<AnimatedPulseRectangle > with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _widthAnimation = Tween<double>(begin: 20.0, end: 60.0).animate(_controller);
  }
